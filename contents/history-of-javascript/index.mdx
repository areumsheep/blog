...
![**참고**: [https://buggyprogrammer.com/difference-between-java-and-javascript/](https://buggyprogrammer.com/difference-between-java-and-javascript/)](images/Slide_16_9_-_2.png)
...
![**출처**: [https://www.pldi21.org/prerecorded_hopl.12.html](https://www.pldi21.org/prerecorded_hopl.12.html)](images/Untitled.png)
...
> ![**출처**: [https://www.slideshare.net/yongho/ss-11966428](https://www.slideshare.net/yongho/ss-11966428)](images/Untitled1.png)
>
> **출처**: [https://www.slideshare.net/yongho/ss-11966428](https://www.slideshare.net/yongho/ss-11966428)

## 히스토리

### 1989~1991년, World Wide Web 개념의 탄생 + WorldWideWeb 브라우저

![**출처**: [https://ko.wikipedia.org/wiki/**팀_버너스리**](https://ko.wikipedia.org/wiki/%ED%8C%80_%EB%B2%84%EB%84%88%EC%8A%A4%EB%A6%AC)](images/Untitled2.png)

**출처**: [https://ko.wikipedia.org/wiki/**팀\_버너스리**](https://ko.wikipedia.org/wiki/%ED%8C%80_%EB%B2%84%EB%84%88%EC%8A%A4%EB%A6%AC)

- 먼저 이 분이 누구인지 아시는 분 계실까요?
  **팀 버너스 리** (Tim Berners-Lee) 입니다.
  World Wide Web의 개념과 기반 기술들은 1989~1991년에 팀 버너스 리에 의해 개발이 되었습니다.
  우리가 웹에 `www` 를 치는 것은 **WorldWideWeb의 약자**입니다.
  ![**출처**: [https://ko.wikipedia.org/wiki/월드와이드웹](https://ko.wikipedia.org/wiki/%EC%9B%94%EB%93%9C%EC%99%80%EC%9D%B4%EB%93%9C%EC%9B%B9)](images/Untitled3.png)
...
![**출처**: [https://www.wired.com/2010/04/0422mosaic-web-browser/](https://www.wired.com/2010/04/0422mosaic-web-browser/)](images/Untitled4.png)
...
![**출처**: [https://www.webdesignmuseum.org/old-software/web-browsers/mosaic-netscape-0-9](https://www.webdesignmuseum.org/old-software/web-browsers/mosaic-netscape-0-9)](images/Untitled5.png)
...
<aside>
⚠️ **1.** Java는 아직 초심자가 사용하긴 어렵다. (진입장벽)
**2.** 경쟁사인 Microsoft에서는 아마추어, 파트타임 프로그래머, 디자이너, 회계사 등을 위해 어려운 Visual C++을 사용하기보단, `**Visual Basic`을 이용해 쉽게 윈도우 프로그램을 개발**하도록 하였다.

</aside>

![**출처**: [https://www.thurrott.com/dev/232268/microsoft-plots-the-end-of-visual-basic](https://www.thurrott.com/dev/232268/microsoft-plots-the-end-of-visual-basic)](images/Untitled6.png)
...
![MSG 포함된 짤입니다 / **추가**: 마크 앤드리슨은 Java의 도움 없이 단독적으로 개발한 언어임을 홍보하길 원했어요.](images/Slide_16_9_-_3.png)
...
![[https://www.webdesignmuseum.org/old-software/web-browsers/netscape-navigator-2-0](https://www.webdesignmuseum.org/old-software/web-browsers/netscape-navigator-2-0)](images/Untitled7.png)
